...
function Eyes() {
  ...
  return (
    <div className="eyes w-full md:h-screen h-[90vh]  overflow-hidden">
      <div data-scroll md:data-scroll-speed="-.4" data-scroll-speed="-.5" className="w-full relative h-full bg-cover bg-center bg-[url('https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg')]">
