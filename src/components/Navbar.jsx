...
function Navbar() {
  return (
    <div
      className="fixed z-[999] backdrop-blur-md  md:w-full w-full md:px-20  py-4 font-['Neue Montreal'] flex 
    ...
    >
      ...
      <div className="links flex md:gap-10 px-10 md:px-0 sm:gap-7 gap-4">
        {["Service", "About Us", "Insight", "Our Work", ].map(
          (item, index) => (
            <a
              key={index}
              className={`md:text-lg hidden md:block  pt-3 cursor-pointer font-normal 
            ${index === 4 && "md:ml-48"}`}
            >
              {item}
            </a>
      ...
      <div className="mt-2 mr-3">
        <button className="border-[2px] uppercase border-zinc-600  font-medium rounded-2xl px-4 py-1 ">Contact Us</button>
      </div>
