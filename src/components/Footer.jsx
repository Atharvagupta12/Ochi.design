...
function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-.1" className="w-full h-fit md:h-screen md:flex bg-zinc-300 md:p-20 p-10  text-black">
      <div className="md:w-1/2 md:h-full  flex md:flex-col justify-between ">
      ...
      <div className="md:w-1/2 mt-20 md:mt-0">
        ...
        <div className="flex justify-between">
          <div>
            <div className="details flex flex-col gap-1 px-2">
              <h1 className="py-5">O:</h1>
              <a
            ...
            <div className="details flex flex-col gap-1 p-2">
              <h1 className="py-5">C:</h1>
              <a
                className="underline underline-offset-4 hover:no-underline"
                href="#"
              >
          ...
          <div>
            ...
            <h1 className="mt-10 p-2">design:</h1>
            <a className="px-2 text-gray-400" href="#">
              OchiDesings@2024
            </a>
          </div>
        </div>
